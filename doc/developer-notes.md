...
CharyCoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
- ThreadRPCServer : Remote procedure call handler, listens on port 11050 for connections and services them.
...
However, in open source software such as CharyCoin Core, where everyone uses
...
pay attention to for reviewers of CharyCoin Core code.

General CharyCoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: CharyCoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
