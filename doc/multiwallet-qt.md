...
Only requiring some minor changes is charycoin.cpp.
...
Changes to charycoin.cpp
----------------------
charycoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
