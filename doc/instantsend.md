...
This mechanism has been integrated into Bitcore-Node-CharyCoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/charycoin/insight-api-charycoin#web-socket-api](https://github.com/charycoin/insight-api-charycoin#web-socket-api)
* API: [https://github.com/charycoin/insight-api-charycoin#instantsend-transactions](https://github.com/charycoin/insight-api-charycoin#instantsend-transactions)
...
By default, the CharyCoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the CharyCoin Core daemon:
