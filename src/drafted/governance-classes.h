 ...
 *
 *   // network
 *   CCharyCoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.charycoin.com/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CCharyCoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CCharyCoinNetwork(UniValue objIn)
    {
...
// // can be under: CharyCoinNetwork
// //   -- signature requirements : Key1(User)
// class CCharyCoinNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == CharyCoinNetwork);
//     // }
