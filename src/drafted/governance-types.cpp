...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "CharyCoinNetwork") type = CharyCoinNetwork;
    if(strType == "CharyCoinNetworkVariable") type = CharyCoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == CharyCoinNetwork) s = "CharyCoinNetwork";
    if(type == CharyCoinNetworkVariable) s = "CharyCoinNetworkVariable";
