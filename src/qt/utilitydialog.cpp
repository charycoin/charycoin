    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("CharyCoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About CharyCoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  charycoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the CharyCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 XRC, 0.1 XRC, 1 XRC and 10 XRC -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("CharyCoin Core is shutting down...") + "<br /><br />" +
