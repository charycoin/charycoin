...
#define BOOST_TEST_MODULE CharyCoin Test Suite

#include "test_charycoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_charycoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
